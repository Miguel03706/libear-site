    ...
    <>
              ...
              <Link href={path} passHref>
                <Button colorScheme="teal" variant="link">
                  {color ? (
                    ...
                    <Image size="64px" src={img} alt={alt} />
                  )}
                  {color ? (
                    <a className={styles.imgSelect}>
                      <div className="label_header">{label}</div>
                    </a>
                  ) : (
                    <a>
                      <div className="label_header">{label}</div>
      ...
      <header className={styles.headerMobile}>
        <Link href="/inicio" passHref>
          <Image
            src="user/user_img/polar.webp"
            h="40px"
            alt="icone de urso polar"
          />
        </Link>
        <nav className="nav">
